...
import { dynamodbFactory } from '../../../../src/adapters/dynamodb/adapter'
import type { ExecuteOptions, ResolvedConnection, ResultEnvelope } from '../../../../src/adapters/types'
...
describe.skipIf(!process.env.TUPLEBASE_IT)('dynamodb adapter (needs `npm run db:start -- dynamo && npm run db:seed -- dynamo`)', () => {
  it('validates config', () => {
